...
def main():
    ...
    # Listen to the cameras
        ...
        # Get the center of the ground truth cameras (Red points)                   
            ...
            print("Points: ", len(pcl_downsampled.points))
        ...
        # Visualize the voxel occupancy grid
            ...
            o3d.visualization.draw_geometries([point_cloud, lidar_pcl])
            
            
            


            np.save('_out/ground_truth/occupancy_grid.npy', voxel_occupancy_grid)  # Save as .npy
            np.savez_compressed('_out/ground_truth/occupancy_grid.npz', voxel_occupancy_grid) # Save as compressed .npz
